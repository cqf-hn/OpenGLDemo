...
import opengldemo.opengldemo.image.Belt2;
...
public class MyGLSurfaceView6 extends GLSurfaceView {

    private SceneRenderer renderer;
    private Belt2 belt;

    public MyGLSurfaceView6(Context context) {
        this(context, null);
    }

    public MyGLSurfaceView6(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //实例化图形对象
            belt = new Belt2(MyGLSurfaceView6.this);
            // 打开深度检测
