...
import opengldemo.opengldemo.image.Belt;
...
public class MyGLSurfaceView4 extends GLSurfaceView {

    private SceneRenderer renderer;
    private Belt belt;

    public MyGLSurfaceView4(Context context) {
        this(context, null);
    }

    public MyGLSurfaceView4(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //实例化图形对象
            belt = new Belt(MyGLSurfaceView4.this);
            // 打开深度检测
